...
import { Grid, Lock, Loader2, AlertCircle, Github } from 'lucide-react';
...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-black flex flex-col md:flex-row overflow-hidden font-sans">
      {/* Left Pane - Brand & Image/Gradient */}
      <div className="w-full md:w-1/2 relative bg-[#1a1a1a] flex flex-col items-center justify-center p-8 md:p-12 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-sm flex flex-col items-center text-center">
          ...
          <p className="text-gray-400 text-sm mb-12">Log in to your account to continue your evolving knowledge journey.</p>
          
          <div className="w-full p-8 rounded-[32px] bg-white/5 border border-white/5 backdrop-blur-xl">
             <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-purple-600 to-blue-600 flex items-center justify-center text-white mx-auto mb-4 shadow-2xl shadow-purple-500/20">
                <Grid size={32} />
             </div>
             <p className="text-white font-bold">Recursive Refinement</p>
             <p className="text-gray-500 text-xs mt-1">Intelligence that compounds.</p>
          </div>
        </div>
      </div>

      {/* Right Pane - Form */}
      <div className="w-full md:w-1/2 bg-black flex flex-col items-center justify-center p-8 md:p-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-white mb-2">Sign In</h2>
            <p className="text-gray-500 text-sm">Enter your credentials to access your vault.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link to="#" className="text-[10px] text-purple-400 font-bold hover:underline">Forgot password?</Link>
              </div>
